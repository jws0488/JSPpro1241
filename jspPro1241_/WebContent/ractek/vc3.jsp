...
function changeImage0() {
	...
	img.src = "../images/vv5.jpg";
	img.style.width = "450px";
	img.style.height = "400px";
}
function changeImage1() {
	var img = document.getElementById("image");
	img.src = "../images/vv6.jpg";
	img.style.width = "450px";
	img.style.height = "400px";
}
</script>
  ...
  <div id="main">		
    <div id="divR">
       <h1>올라운드형 라켓 추천 리스트</h1>
		<img id="image" src="../images/vcvc.PNG" width="450px" height="400px"><br>			
		<input type="button" value="HX-20H" onclick="changeImage0()"><br>
		<input type="button" value="브레이브소드12" onclick="changeImage1()">		
    </div>
 </div>
   <div id="footer1">
