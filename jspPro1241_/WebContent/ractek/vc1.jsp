...
function changeImage0() {
	...
	img.src = "../images/vv1.jpg";
	img.style.width = "450px";
	img.style.height = "400px";
}
function changeImage1() {
	var img = document.getElementById("image");
	img.src = "../images/vv2.jpg";
	img.style.width = "450px";
	img.style.height = "400px";
}
</script>
  ...
  <div id="main">		
    <div id="divR">
       <h1>공격형 라켓 추천 리스트</h1>
		...
		<input type="button" value="트위스터" onclick="changeImage0()"><br>
		<input type="button" value="METEOP X90" onclick="changeImage1()">	
    </div>
 </div>
   <div id="footer1">
