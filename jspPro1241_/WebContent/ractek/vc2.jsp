...
function changeImage0() {
	...
	img.src = "../images/vv3.jpg";
	img.style.width = "450px";
	img.style.height = "400px";
}
function changeImage1() {
	var img = document.getElementById("image");
	img.src = "../images/vv4.jpg";
	img.style.width = "450px";
	img.style.height = "400px";
}
</script>
  ...
  <div id="main">		
    <div id="divR">
       <h1>수비형 라켓 추천 리스트</h1>
		...
		<input type="button" value="제트스피드s11" onclick="changeImage0()"><br>
		<input type="button" value="하이퍼나노x900" onclick="changeImage1()">	
    </div>
 </div>
   <div id="footer1">
