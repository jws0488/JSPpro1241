...
function changeImage0() {
	...
	img.src = "../images/yy4.jpg";
	img.style.width = "450px";
	img.style.height = "370px";
}
function changeImage1() {
	var img = document.getElementById("image");
	img.src = "../images/yy5.jpg";
	img.style.width = "450px";
	img.style.height = "370px";
}
function changeImage2() {
	var img = document.getElementById("image");
	img.src = "../images/yy6.jpg";
	img.style.width = "450px";
	img.style.height = "370px";
}
  ...
  <div id="main">		
    <div id="divR">
       <h1>수비형 라켓 추천 리스트</h1>
		...
		<input type="button" value="듀오라6" onclick="changeImage0()"><br>
		<input type="button" value="아크세이버1투어" onclick="changeImage1()"><br>
		<input type="button" value="아크세이버FB" onclick="changeImage2()">
    </div>
 </div>
   <div id="footer1">
