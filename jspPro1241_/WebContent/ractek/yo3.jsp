...
function changeImage0() {
	...
	img.src = "../images/yy7.jpg";
	img.style.width = "450px";
	img.style.height = "370px";
}
function changeImage1() {
	var img = document.getElementById("image");
	img.src = "../images/yy8.jpg";
	img.style.width = "450px";
	img.style.height = "370px";
}
function changeImage2() {
	var img = document.getElementById("image");
	img.src = "../images/yy9.jpg";
	img.style.width = "450px";
	img.style.height = "370px";
}
...
<div id="page">
  ...
  <div id="main">		
    <div id="divR">
       <h1>올라운드형 라켓 추천 리스트</h1>
		<img id="image" src="../images/yoyo.PNG" width="450px" height="370px"><br>
		<input type="button" value="아크세이버4DX" onclick="changeImage0()"><br>
		<input type="button" value="아크세이버11" onclick="changeImage1()"><br>
		<input type="button" value="나노레이900" onclick="changeImage2()">
    </div>
 </div>
   <div id="footer1">
